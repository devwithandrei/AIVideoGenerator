...
import { generateVideoFromReference } from "@/ai/flows/generate-video-from-reference";
...
export function ReferenceToVideoTab() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    if (uploadedImages.length === 0 && uploadedReferences.length === 0) {
      toast({
        title: "No Media Uploaded",
        description: "Please upload at least one image or reference.",
        variant: "destructive",
      });
      return;
    }
    ...
    try {
      ...
      toast({
        title: "Success!",
        description: "Your video has been generated from references.",
      });
    } catch (error) {
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              Generate Videos with Multi-Reference Consistency
            </CardTitle>
            <CardDescription>
              Upload one or more characters, objects, or scenes as references, describe the content you want to generate.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Form {...form}>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea
                          placeholder="Describe the video you want to generate based on your references... (Keep content appropriate and family-friendly)"
                ...
                <div className="absolute top-2 right-2 flex gap-2">
                  <Button
                    ...
                    onClick={() => {
                      ...
                      link.href = videoUrl;
                      link.download = `reference-video-${Date.now()}.mp4`;
